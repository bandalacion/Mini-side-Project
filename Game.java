...
public class Game {
	...
	public static void main(String[] args) {
		...
		// Main game loop for direction choices
	...
	public static void chooseDirection(String name) {
		while (true) {
			...
			if (direction.equalsIgnoreCase("quit")) {
				...
				if (handleNorthDirection(name)) {
					continue; // Go back to direction selection
				}
			}
			else if (direction.equalsIgnoreCase("south")) {
				if (handleSouthDirection(name)) {
					continue; // Go back to direction selection
				}
			}
			else if (direction.equalsIgnoreCase("east")) {
				if (handleEastDirection(name)) {
					continue; // Go back to direction selection
				}
			}
			else if (direction.equalsIgnoreCase("west")) {
				if (handleWestDirection(name)) {
					continue; // Go back to direction selection
				}
			}
			else {
